    ...
    return (
        <section id="headline" className={`d-block ${style.bgHeadline} vh-100 d-flex align-items-center justify-content-center`}>
            <div className="d-flex flex-column justify-content-center align-items-center">
                <h3 className={ `${ style.textColor } fw-bold m-0` }>The Wedding Of</h3>
                <p className={ `${ style.textColor } fs-1 fw-bold py-2 px-3 m-0` } style={{ letterSpacing: 2 }}>James & Humairoh</p>
