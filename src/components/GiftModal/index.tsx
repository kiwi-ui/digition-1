            ...
            <div className="w-50 top-50">
                <div className="rounded-5 container" style={{background:"#f1d6ab"}}>
                    <div className="px-2 d-flex justify-content-end">
                        <button className="bg-transparent border-0" style={{ fontSize: '3rem' }} type="button" onClick={ toggleModal }><GrFormClose /></button>
                    </div>

                    <div className="text-center p-4">
                        <img src={ qr } className="h-50" alt="qr code" />  
                        <div className="my-2">
                            <p className="fs-1 fw-bold m-0">Juliet Basori</p>
                            <p className='fs-1'>091204789789 / Bank Mandiri</p>
                        </div>
                        <div className="d-flex justify-content-center gap-3">
                            <button className="fs-2 py-2 px-4 position-relative rounded-2 border-0 text-white fw-semibold" style={{ background: "#2b2b2b" }} onClick={copyId}>Copy</button>
                        ...
                        <p className={`${ showCopy ? "d-block" : "d-none" } position-fixed translate-middle-x start-50 rounded-3 text-white p-3`} style={{ fontSize: "2.5rem", top: "85%" }}>Copied</p>
                    </div>
                </div>
            </div>
        </div> 
